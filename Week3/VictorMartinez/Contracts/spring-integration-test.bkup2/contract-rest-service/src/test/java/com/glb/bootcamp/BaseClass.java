...
public abstract class BaseClass {
	...
	@Before public void setup() {
		...
		Mockito.when(customerService.addCustomerByName(new Customer(4L, "William", "Diaz")))
				.thenReturn(new Customer(4L, "William", "Diaz"));

		Mockito.when(customerService.addCustomerById(new Customer(5L, "Thomas", "Pelaez")))
				.thenReturn(new Customer(5L, "Thomas", "Pelaez"));

		Mockito.when(customerService.updateCustomerById(1l, new Customer(1L, "Mike", "Gutierrez")))
